...
//           children: [
//             // Text('ID: ${sale.id}', style: Theme.of(context).textTheme.headline6),
//             SizedBox(height: 8),
//             Text('Date: ${widget.sale.date}', style: Theme.of(context).textTheme.bodyText1),
//             SizedBox(height: 8),
//             Text('Customer Name: ${widget.sale.customerName}', style: Theme.of(context).textTheme.bodyText1),
//             SizedBox(height: 8),
//             Text('Customer Number: ${widget.sale.customerNumber}', style: Theme.of(context).textTheme.bodyText1),
//             SizedBox(height: 16),
...
//               'Total Amount: \$${widget.sale.totalAmount ?? 0.0}', // Default to 0.0 if null
    ...
    return Card(
      ...
      child: Padding(
        ...
        child: Column(
          crossAxisAlignment: CrossAxisAlignment.start,
          children: [
            Text('Sale Information', style: Theme.of(context).textTheme.headline6),
            Divider(),
