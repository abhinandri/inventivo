...
//     double todaysRevenue = 0.0;
//     int totalSales = 0;
//     List<double> monthlyRevenue = List.filled(12, 0.0); // For monthly revenue tracking
...
//             monthlyRevenue[monthIndex] += sale.totalAmount ?? 0.0; // Aggregate revenue for the month
//         }
//     }
...
//           double totalRevenue = revenueData['totalRevenue'];
//           int totalSales = revenueData['totalSales'];
//           List<double> monthlyRevenue = revenueData['monthlyRevenue'] ?? List.filled(12, 0.0);
